  ...
  return (
    <div>
      <div className='bg-[url("/head.png")] h-[350px] w-full sm:bg-cover hidden md:flex justify-center items-center'>
        <div>
           <h1 className='openSans sm:text-[48px] text-[32px] text-white'>FAQ Page</h1>
      ...
      <div className='w-full h-full flex justify-center'>
        <div className='w-[1320px] mt-4 lg:mt-12 mb-12'>
            <div>
                <h1 className='openSans lg:text-[48px] sm:text-[32px] text-[18px] lg:leading-[56px] text-zinc-900 text-center'>Questions Looks Here</h1>
                <p className='inter lg:text-[18px] sm:text-[14px] text-[8px] lg:leading-6 text-zinc-600 text-center'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ullam quod blanditiis est!</p>
            </div>
            <div className='grid grid-cols-1 grid-rows-6 gap-1 sm:grid-cols-2 sm:grid-rows-3 lg:mt-16 mt-2 p-2 space-y-2 lg:space-y-4'>
