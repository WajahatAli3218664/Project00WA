  ...
  return (
    <div>
      <div className='bg-[url("/head.png")] h-[350px] w-full sm:bg-cover hidden md:flex justify-center items-center'>
        <div>
           <h1 className='openSans sm:text-[48px] text-[32px] text-white'>Your Bag</h1>
      ...
      <div className='w-full flex justify-center items-center'>
        <ul className='2xl:w-[1320px] w-full lg:p-12 md:p-8 p-4'>
            <li className='lg:flex hidden justify-between openSans text-[16px] leading-[24px]'>
                <p>Products</p>
                <p>Price</p>
                <p>Quantity</p>
                <p>Total</p>
            ...
            <li className='flex sm:items-center lg:justify-normal justify-between openSans text-[16px] leading-[24px] py-3 border-b-[1px] border-zinc-200'>
                ...
                <div className='lg:flex-row flex flex-col'>
                    ...
                    <p className='xl:ml-52 lg:ml-36 sm:flex hidden'>$173.00</p>
                    <p className='text-zinc-700 xl:ml-48 ml-36 lg:flex hidden hover:text-primYellow cursor-pointer'>X</p>  
                </div>
            ...
            <li className='flex sm:items-center lg:justify-normal justify-between openSans text-[16px] leading-[24px] py-3 border-b-[1px] border-zinc-200'>
                ...
                <div className='lg:flex-row flex flex-col'>
                    ...
                    <p className='xl:ml-48 lg:ml-32 sm:flex hidden'>1</p>
                    <p className='xl:ml-52 lg:ml-36 sm:flex hidden'>$233.00</p>
                    <p className='text-zinc-700 xl:ml-48 ml-36 lg:flex hidden hover:text-primYellow cursor-pointer'>X</p>  
                </div>
            </li>
            <li className='flex sm:items-center lg:justify-normal justify-between openSans text-[16px] leading-[24px] py-3 border-b-[1px] border-zinc-200'>
                ...
                <div className='lg:flex-row flex flex-col'>
                    ...
                    <p className='xl:ml-48 lg:ml-32 sm:flex hidden'>1</p>
                    <p className='xl:ml-52 lg:ml-36 sm:flex hidden'>$421.00</p>
                    <p className='text-zinc-700 xl:ml-48 ml-36 lg:flex hidden hover:text-primYellow cursor-pointer'>X</p>  
                </div>
            </li>
            <li className='xl:flex hidden items-center openSans text-[16px] leading-[24px] py-3 border-b-[1px] border-zinc-200'>
                ...
                <p className='xl:ml-52 lg:ml-36'>$275.00</p>
                <p className='text-zinc-700 xl:ml-48 lg:ml-36 hover:text-primYellow cursor-pointer'>X</p>
            </li>
            <li className='xl:flex hidden items-center openSans text-[16px] leading-[24px] py-3 border-b-[1px] border-zinc-200'>
                <div>
                ...
                <p className='text-zinc-700 xl:ml-[82px]'>$15.00</p>
                <p className='xl:ml-48 lg:ml-32'>1</p>
                <p className='xl:ml-52 lg:ml-36'>$195.00</p>
                <p className='text-zinc-700 xl:ml-48 lg:ml-36 hover:text-primYellow cursor-pointer'>X</p>
            </li>
        </ul>
      </div>
